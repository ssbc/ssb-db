...
### SecureScuttlebutt#createHistoryStream ({id: pubkey, seq: int?, live: bool?}) -> PullSource
...
### SecureScuttlebutt#links ({source: pubkey?, dest: hash?, rel: string?, meta: true?, keys: true?, values: false?, live:false?, reverse: false?}) -> PullSource
...
### SecureScuttlebutt#relatedMessages ({id: pubkey, rel: string?, count: false?, parent: false?}, cb)
