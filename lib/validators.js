...
module.exports = valid({
  ...
  msg: function (v, n) {
    ...
    if (!v.content) return MissingAttr(n, 'content', 'object|string')
  ...
  readStreamOpts: function (v, n) {
    ...
    if (
      v.values &&
      typeof v.values !== 'boolean' &&
      typeof v.values !== 'number'
    ) {
    ...
    if (
      v.fillCache &&
      typeof v.fillCache !== 'boolean' &&
      typeof v.fillCache !== 'number'
    ) {
